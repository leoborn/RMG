...
public class Vierklang extends Akkord{
	...
	public Vierklang( String name, int oktave, String instrument, Note[] noten ){
	...
	public Vierklang( String instrument, Note n ){
	...
	public static Note[] checkNoten( Note[] noten ) throws IllegalArgumentException {
		if( noten.length == 4 ){
			...
			throw new IllegalArgumentException("Zu viele Noten fuer einen Driklang.");
		}
	}
